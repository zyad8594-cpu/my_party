...
-- ======================================================
CALL sp_create_coordinator('أحمد السقا', '714212208', 'https://i.pravatar.cc/150?u=ahmed', 'ahmed@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('سعد الهندي', '714332208', 'https://i.pravatar.cc/150?u=sad', 'sadalh@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('منى النجار', '712345678', 'https://i.pravatar.cc/150?u=mona', 'mona@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('نضال حمود', '713456789', 'https://i.pravatar.cc/150?u=nidal', 'nidal@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('رنا القدسي', '714567890', 'https://i.pravatar.cc/150?u=rana', 'rana@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('باسم فؤاد', '715678901', 'https://i.pravatar.cc/150?u=bassem', 'bassem@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('هدى العفيف', '716789012', 'https://i.pravatar.cc/150?u=hoda', 'hoda@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('كمال الدين', '717890123', 'https://i.pravatar.cc/150?u=kamal', 'kamal@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('سوسن بكر', '718901234', 'https://i.pravatar.cc/150?u=sawsan', 'sawsan@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('جمال عارف', '719012345', 'https://i.pravatar.cc/150?u=gamal', 'gamal@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('لينا صبري', '710123456', 'https://i.pravatar.cc/150?u=lina', 'lina@myparty.com', '123456', FALSE);
CALL sp_create_coordinator('ياسر العمري', '711234567', 'https://i.pravatar.cc/150?u=yasser', 'yasser@myparty.com', '123456', FALSE);
...
-- ======================================================
CALL sp_create_supplier('سامي الذهبي', '711282993', 'https://i.pravatar.cc/150?u=sami', 'sami@myparty.com', '123456', 'صنعاء', 'مورد معتمد', JSON_ARRAY(1,2,9,10), FALSE);
CALL sp_create_supplier('خالد السامعي', '773887987', 'https://i.pravatar.cc/150?u=khaled', 'khaled@myparty.com', '123456', 'إب', 'خبرة 10 سنوات', JSON_ARRAY(3,4,5,6), FALSE);
CALL sp_create_supplier('غرام العبسي', '775653456', 'https://i.pravatar.cc/150?u=gram', 'gram@myparty.com', '123456', 'تعز', 'تجهيزات فاخرة', JSON_ARRAY(7,8,11,12), FALSE);
CALL sp_create_supplier('أكرم الخطيب', '883214567', 'https://i.pravatar.cc/150?u=akram', 'akram@myparty.com', '123456', 'عدن', 'خدمات سريعة', JSON_ARRAY(1,3,5,7), FALSE);
CALL sp_create_supplier('نوال حسن', '712233445', 'https://i.pravatar.cc/150?u=nawal', 'nawal@myparty.com', '123456', 'صنعاء', 'متخصصة في الديكور', JSON_ARRAY(3,9), FALSE);
CALL sp_create_supplier('عبدالله نعمان', '713344556', 'https://i.pravatar.cc/150?u=abdullah', 'abdullah@myparty.com', '123456', 'الحديدة', 'أجهزة صوت وإضاءة', JSON_ARRAY(2,9), FALSE);
CALL sp_create_supplier('فاطمة الزهراء', '714455667', 'https://i.pravatar.cc/150?u=fatima', 'fatima@myparty.com', '123456', 'إب', 'تصوير احترافي', JSON_ARRAY(4,10), FALSE);
CALL sp_create_supplier('ياسر المنصور', '715566778', 'https://i.pravatar.cc/150?u=yaser', 'yaser@myparty.com', '123456', 'تعز', 'تنظيم حفلات', JSON_ARRAY(5,11), FALSE);
CALL sp_create_supplier('شذى القادري', '716677889', 'https://i.pravatar.cc/150?u=shatha', 'shatha@myparty.com', '123456', 'عدن', 'خدمات ضيافة', JSON_ARRAY(6,12), FALSE);
CALL sp_create_supplier('مروان السقاف', '717788990', 'https://i.pravatar.cc/150?u=marwan', 'marwan@myparty.com', '123456', 'صنعاء', 'أمن وحراسة', JSON_ARRAY(7), FALSE);
CALL sp_create_supplier('إيمان باسندوة', '718899001', 'https://i.pravatar.cc/150?u=eman', 'eman@myparty.com', '123456', 'المكلا', 'نقل وتوصيل', JSON_ARRAY(8), FALSE);
CALL sp_create_supplier('خالد الطيب', '719900112', 'https://i.pravatar.cc/150?u=khaled2', 'khaled2@myparty.com', '123456', 'سيئون', 'تنظيف متكامل', JSON_ARRAY(12), FALSE);
